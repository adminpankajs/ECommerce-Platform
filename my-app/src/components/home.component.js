    ...
    return (
        <div style={{zIndex: "-1"}}>
            <div style={{position: "relative", overflow: "hidden"}}>
                <img style={{boxShadow: "inset 0px -20px black",width: "100%",height: "100%"}} src={constants.websiteProductImages+'/homepage/homepage-tv.jpg'}></img>
                <div className="homepage-landing-left">New Arrival</div>
                <div className="homepage-landing-left-subheading">Samsung 4k OLED TV</div>
